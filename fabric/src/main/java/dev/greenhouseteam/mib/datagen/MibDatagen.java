...
public class MibDatagen implements DataGeneratorEntrypoint {
    ...
    private static class DynamicRegistryGenerator extends FabricDynamicRegistryProvider {
        ...
        protected void configure(HolderLookup.Provider registries, Entries entries) {
            entries.add(MibSoundSets.ACOUSTIC_GUITAR, new MibSoundSet(Map.of(KeyWithOctave.DEFAULT, List.of(new ExtendedSound(new ExtendedSound.Sounds(BuiltInRegistries.SOUND_EVENT.getHolderOrThrow(BuiltInRegistries.SOUND_EVENT.getResourceKey(MibSoundEvents.ACOUSTIC_GUITAR).orElseThrow())))))));
            entries.add(MibSoundSets.COPPER_GOAT_HORN, new MibSoundSet(Map.of(KeyWithOctave.DEFAULT, List.of(new ExtendedSound(new ExtendedSound.Sounds(BuiltInRegistries.SOUND_EVENT.getHolderOrThrow(BuiltInRegistries.SOUND_EVENT.getResourceKey(MibSoundEvents.COPPER_GOAT_HORN_START).orElseThrow()), BuiltInRegistries.SOUND_EVENT.getHolderOrThrow(BuiltInRegistries.SOUND_EVENT.getResourceKey(MibSoundEvents.COPPER_GOAT_HORN_LOOP).orElseThrow())), 30, ConstantFloat.of(0.0075F))))));
            ...
            entries.add(MibSoundSets.FLUTE, new MibSoundSet(Map.of(KeyWithOctave.DEFAULT, List.of(new ExtendedSound(new ExtendedSound.Sounds(BuiltInRegistries.SOUND_EVENT.getHolderOrThrow(BuiltInRegistries.SOUND_EVENT.getResourceKey(MibSoundEvents.FLUTE_START).orElseThrow()), BuiltInRegistries.SOUND_EVENT.getHolderOrThrow(BuiltInRegistries.SOUND_EVENT.getResourceKey(MibSoundEvents.FLUTE_LOOP).orElseThrow())), 30, ConstantFloat.of(0.0075F))))));
            entries.add(MibSoundSets.HARPSICHORD, new MibSoundSet(Map.of(KeyWithOctave.DEFAULT, List.of(new ExtendedSound(new ExtendedSound.Sounds(BuiltInRegistries.SOUND_EVENT.getHolderOrThrow(BuiltInRegistries.SOUND_EVENT.getResourceKey(MibSoundEvents.HARPSICHORD).orElseThrow())))))));
